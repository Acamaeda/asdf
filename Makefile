# Makefile for um out (Comp 40 Assignment 6)
# 
# Harley White and Rhys Gilkenson
# 
...
# 
CFLAGS = -g -Ofast -std=gnu99 -Wall -Wextra -Werror -Wfatal-errors -pedantic $(IFLAGS)
...
# netpbm is needed for pnm, arith40 is needed for arith40.c
# rt is for the "real time" timing library, which contains the clock support
LDLIBS = -lcii40-O2 -lnetpbm -lcii40 -lm -lrt -L/comp/40/lib64 -larith40 -l40locality
...
# Includes additional executables from testing
